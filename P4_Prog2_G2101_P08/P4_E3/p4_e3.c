/*
Notas:
-- Corrección de errores por falta de definiciones de funciones auxiliares
		para inicializar el arbol binario de busqueda
...
void destroy_node_function(void * src);
void* copy_node_function(const void* src);
int print_node_function(FILE* pf, const void*src);
